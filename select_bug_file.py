...
if __name__ == "__main__":
    directory = '/run/user/1001/gvfs/smb-share:server=synology_nas.local,share=zhouyuan/'
    # test_rounds = ['random_1', 'random_2','random_3','random_4','random_5']
    test_rounds = 'ga_1/'
    # scenarios = ['intersection1', 'intersection2', 'intersection3', 'intersection4', 'intersection5', 'lanechange1',
    #              'lanechange3', 'overtaking1']
    scenarios = ['overtaking1']
    select_bug_test_cases_all(directory + test_rounds, scenarios)
