                        ...
                        if len(output_trace['trace']) > 1:
                            ...
                            if encoded_testcase.fitness <= 0.0:
                                ...
                                for spec in remaining_sub_violations:                                    
                                    fitness = monitor.continuous_monitor2(spec)  
                                    if fitness >= 0.0:
                                        covered.append(spec)
                                ...
                                for itme in covered:
                                    ...
                                    with open(directory + '/improvedTestCase.txt', 'a') as bug_file:
                                        ...
                                        string_index2 ='Running Generation: {}, Individual: {}\n'.format(0, 0)
                                        bug_file.write(string_index2)
                                        string_index3 = "Covered rate is: {}/{} = {}\n".format((maximun - len(remaining_sub_violations)), maximun, coverage_rate)
                            ...
                            if encoded_testcase.fitness <= 0.0:
                                ...
                                for itme in covered:
                                    ...
                                    with open(directory + '/improvedTestCase.txt', 'a') as bug_file:
                                        ...
                                        bug_file.write(string_index)
                                        coverage_rate = 1- len(remaining_sub_violations) / maximun
                                        string_index2 ='Running Generation: {}, Individual: {}\n'.format(generation, individual_number)
                                        bug_file.write(string_index2)
                                        string_index3 = "Covered rate is: {}/{} = {}\n".format((maximun - len(remaining_sub_violations)), maximun, coverage_rate)
                                        bug_file.write(string_index3)
                                        json.dump(output_trace, bug_file, indent=2)
...
def test_scenario(direct, item):
    file = direct + item
    log_direct = "random5.0_3/" + Path(item).stem
...
if __name__ == "__main__":
    ...
    # arr = ['lane_change_in_the_same_road.txt', 'Intersection_with_Double-Direction_Roads.txt']
    # arr = ['Intersection_with_Double-Direction_Roads.txt']
    for item in arr:
