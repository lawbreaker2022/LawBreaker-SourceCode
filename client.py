...
def test_scenario(direct, item):
    file = direct + item
    log_direct = 'ga_0_rule38_apollo6.0/' + Path(item).stem
    # print(log_direct)
    ...
    for i in range(len(testcases)):
        ...
        try:
            ...
            for spec_index in range(len(specifications_in_scenario)):
                ...
                spec_scenario(spec=single_specification, testcase=test_case, generations=25, pop_size=20,
...
if __name__ == "__main__":
    ...
    # items = ['Intersection_with_Single-Direction_Roads_lane_change.txt']
    items = ['lane_change_in_the_same_road.txt', 'lane_change_far_away_from_the_intersection.txt', 'overtaking_with_static_agents_ahead.txt', 'Intersection_with_Single-Direction_Roads_lane_change.txt']    

    # direct = 'test_cases/Violations/'
    # items = ['stuck2.txt']
    # arr = ['lanechange2.txt', 'lanechange3.txt', 'overtaking1.txt']
    # for item in arr:
    ...
    # items = [ 'lane_change_near_the_intersection.txt', 'T-Junction.txt', 'overtaking_with_static_agents_ahead.txt'\
    #      'lane_change_in_the_same_road.txt', 'lane_change_far_away_from_the_intersection.txt', 'Intersection_with_Stop_Signs.txt', \
    #      'Intersection_with_Single-Direction_Roads.txt', 'Intersection_with_Mixed-Direction_Roads.txt', 'Intersection_with_Double-Direction_Roads.txt'\
    #      ]
    # items = ['Intersection_with_Single-Direction_Roads_lane_change.txt', 'Intersection_with_Mixed-Direction_Roads.txt', 'Intersection_with_Double-Direction_Roads.txt']    
    # items = []
    for item in items:
        test_scenario(direct, item)
